...
<div class="container borde bg-light">
    <form action="../backend/login_back.php" method="post" enctype="multipart/form-data" onsubmit="return checkError()">
        ...
        <div class="offset-md-6 col-md-1">
            <input type="submit" class="btn btn-success btn-xs" value="登录" onsubmit="return checkError()">
        </div>
        <br>
    </form>
</div>
